...
/***/ function(module, exports, __webpack_require__) {
	...
	var Song = function Song(props) {
	  ...
	  var playAudio = function playAudio(event) {
	  ...
	  return React.createElement(
	    'div',
	    null,
	    React.createElement('img', { className: 'audio-control', src: 'https://image.freepik.com/free-icon/play-button_318-42541.jpg', width: '60', onClick: playAudio }),
	    ...
	    React.createElement('audio', { id: 'audio' + props.position, src: props.audio })
	  );
	};
