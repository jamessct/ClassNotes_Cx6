...
/***/ function(module, exports, __webpack_require__) {
	...
	var CountryDetail = __webpack_require__(161);
	...
	var CountriesBox = React.createClass({
	  ...
	  setFocusCountry: function setFocusCountry(country) {
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(CountriesSelector, { countries: this.state.countries, selectCountry: this.setFocusCountry }),
	      React.createElement(CountryDetail, { country: this.state.focusCountry })
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CountriesSelector = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      "select",
	      { id: "countries", value: this.state.selectedIndex, onChange: this.handleChange },
	      options
	    );
	  }
	});
