...
/***/ function(module, exports, __webpack_require__) {
	...
	var BitcoinPricer = __webpack_require__(159);
	
	window.onload = function () {
	  ReactDOM.render(React.createElement(BitcoinPricer, { url: 'http://api.coindesk.com/v1/bpi/currentprice.json' }), document.getElementById('app'));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var PriceDisplay = __webpack_require__(160);
	
	var BitcoinPricer = React.createClass({
	  displayName: 'BitcoinPricer',
	  ...
	  render: function render() {
	    var priceInfo = React.createElement(PriceDisplay, { price: this.state.price });
