...
/***/ function(module, exports, __webpack_require__) {
	...
	var OpeningsBox = __webpack_require__(159);
	...
	window.onload = function () {
	  ReactDOM.render(React.createElement(OpeningsBox, { movies: movies }), document.getElementById('app'));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MovieTable = __webpack_require__(161);
	var MoreLink = __webpack_require__(163);
	var ShowTimesButton = __webpack_require__(164);
	
	var OpeningsBox = React.createClass({
	  displayName: 'OpeningsBox',
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(Header, { title: 'UK Opening This Week' }),
	      React.createElement(MovieTable, { movies: this.props.movies }),
	      React.createElement(MoreLink, null),
	      React.createElement(ShowTimesButton, { handleClick: this.handleClick })
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var MovieRow = __webpack_require__(162);
	
	var MovieTable = function MovieTable(props) {
	
	  var movieNodes = props.movies.map(function (movie) {
	    return React.createElement(
	      'li',
	      null,
	      React.createElement(MovieRow, { movie: movie })
	    );
	  });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ShowTimesButton = function ShowTimesButton(props) {
	
	  return React.createElement(
	    'div',
	    { className: 'show-times' },
	    React.createElement(
	      'button',
	      { className: 'btn-show-times', onClick: props.handleClick },
	      'Get Show Times >>'
	    )
	  );
	};
