...
[i]: Explain - only if we're doing Rails week after React
...
[i]: Draw diagram of models/view divided and the being bundled into browser.
...
Go to the website, to see the three main charateristics of React.
